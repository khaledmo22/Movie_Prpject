...
const WatchPage = () => {
  ...
  const { contentType } = useContentStore(); // Get content type from zustand store
        ...
        <div className="aspect-video mb-8 p-2 sm:px-10 md:px-32">
          {trailers.length > 0 && (
            <ReactPlayer
              ...
              url={`https://www.youtube.com/watch?v=${trailers[currentTrailerIdx].key}`} // Ensure the correct URL
            />
          )}
