...
export async function getSimilarMovies(req, res) {
	const { id } = req.params;
	try {
		const data = await fetchFromTMDB(`https://api.themoviedb.org/3/movie/${id}/similar?language=en-US&api_key=c2f4d760699d97ab22c0d8b3b3f9c44f`);
...
export async function getMoviesByCategory(req, res) {
	...
	try {
		const data = await fetchFromTMDB(`https://api.themoviedb.org/3/movie/${category}?language=en-US&api_key=c2f4d760699d97ab22c0d8b3b3f9c44f`);
